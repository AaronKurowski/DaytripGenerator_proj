        ...
        if(acceptancePrompt === 'yes'){
            ...
            if(userChange.toLowerCase() === 'destination'){
                ...
                if(destinations.length === 0){
                    ...
                    break;
                    //pickedDestination = "We've run out of destinations!";
                    //displayTrip();
                }
                else{
                    pickedDestination = randomDestination();
            ...
            // change entertainment
                ...
                if(entertainment.length === 0){
                    pickedEntertainment = "No options left";
                    displayTrip();
                }
                else{
                    pickedEntertainment = randomEntertainment();
                ...
                console.log("Type one of the options again");
            }
        }
    }
}
